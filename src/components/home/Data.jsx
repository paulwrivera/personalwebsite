...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Paul Hobbs
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">Hi, I'm Paul, a front end developer and brand designer who loves to create projects that have <b>impactful</b> design.</p>
